...
#             background_image_path = 'C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/simple_world_light.png'
...
#             background_image_path = 'C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/NH_center.png'
#             img_data = Image.open(background_image_path)
#             image = np.copy(img_data)
#             self.background_img = pg.ImageItem(image)
#             self.traj_pw.addItem(self.background_img)
...
#             background_image_path = 'C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/city_400.png'
#             img_data = Image.open(background_image_path)
#             image = np.copy(img_data)
#             self.background_img = pg.ImageItem(image)
#             self.traj_pw.addItem(self.background_img)
...
#             background_image_path = 'C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/trees_200_200.png'
#             img_data = Image.open(background_image_path)
#             image = np.copy(img_data)
#             self.background_img = pg.ImageItem(image)
#             self.traj_pw.addItem(self.background_img)
...
#             background_image_path = 'C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/Forest.png'
#             img_data = Image.open(background_image_path)
#             image = np.copy(img_data)
#             self.background_img = pg.ImageItem(image)
#             self.traj_pw.addItem(self.background_img)
...
class TrainingUi(QWidget):
    """Minimal UI that only shows the trajectory plot."""
    ...
    def init_ui(self):
        ...
        traj_gb = self.create_traj_plot_groupbox()
        layout = QVBoxLayout()
        layout.addWidget(traj_gb)
        self.setLayout(layout)

    def create_traj_plot_groupbox(self):
        traj_plot_groupbox = QGroupBox('Trajectory')
        # 设置 trajectory 图的大小（宽度和高度，单位：像素）
        # 可以根据需要修改这两个值来调整图的大小
        traj_width = 1200   # 图的宽度
        traj_height = 1200  # 图的高度
        traj_plot_groupbox.setFixedHeight(traj_height)
        traj_plot_groupbox.setFixedWidth(traj_width)
        layout = QVBoxLayout()
        ...
        self.traj_pw.setXRange(max=140, min=-140)
        self.traj_pw.setYRange(max=140, min=-140)
        self.traj_pw.invertY()  # Match AirSim coordinate system (Y down)

        env_name = self.cfg.get('options', 'env_name')
        if env_name == 'SimpleAvoid':
            self._load_background('C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/simple_world_light.png', -60, -60, 120, 120)
            self.traj_pw.setXRange(max=60, min=-60)
            self.traj_pw.setYRange(max=60, min=-60)
        elif env_name == 'NH_center':
            self._load_background('C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/NH_center.png', -135, -135, 270, 270)
            self.traj_pw.setXRange(max=135, min=-135)
            self.traj_pw.setYRange(max=135, min=-135)
        elif env_name == 'City_400':
            self._load_background('C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/city_400.png', -220, -220, 440, 440)
            self.traj_pw.setXRange(max=220, min=-220)
            self.traj_pw.setYRange(max=220, min=-220)
        elif env_name == 'Tree_200':
            self._load_background('C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/trees_200_200.png', -100, -100, 200, 200)
            self.traj_pw.setXRange(max=100, min=-100)
            self.traj_pw.setYRange(max=100, min=-100)
        elif env_name == 'Forest':
            self._load_background('C:/Users/22864/UAV_Navigation_DRL_AirSim/resources/env_maps/Forest.png', -100, -100, 200, 200)
            self.traj_pw.setXRange(max=100, min=-100)
            self.traj_pw.setYRange(max=100, min=-100)
    ...
    def _load_background(self, path, x, y, width, height):
        img_data = Image.open(path)
        image = np.copy(img_data)
        self.background_img = pg.ImageItem(image)
        self.traj_pw.addItem(self.background_img)
        self.background_img.setZValue(-100)  # Behind trajectory
    ...
    def state_cb(self, step, state_raw): pass
    def attitude_plot_cb(self, step, attitude, attitude_cmd): pass
    def reward_plot_cb(self, step, reward, total_reward): pass
    def lgmd_plot_cb(self, min_dist, lgmd_out, lgmd_split): pass